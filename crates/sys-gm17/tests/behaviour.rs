//! What the adapter itself promises around ark-gm17: fresh prover randomness, and undecodable bytes
//! reported as malformed rather than as errors.

#![allow(clippy::unwrap_used, clippy::expect_used)]

use sys_gm17::{Field, Fr, Gm17};
...
fn the_same_claim_proved_twice_gives_two_different_proofs_that_both_verify() {
    ...
    let mut prepared = Gm17.prepare(ExampleId::OnePlusOne, &control).unwrap();
